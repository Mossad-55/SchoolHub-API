...
public class BatchForCreationDtoValidator : AbstractValidator<BatchForCreationDto>
{
    public BatchForCreationDtoValidator()
    {
        RuleFor(x => x.Name)
        ...
        RuleFor(x => x.CreatedDate)
            .Must(cd => cd is null || cd.Value <= DateTime.UtcNow)
